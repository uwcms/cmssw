...
private:
  ...
  edm::InputTag ecalTPGLabel;
  edm::InputTag hcalTPGLabel;
...
L1TCaloLayer1RawToDigi::L1TCaloLayer1RawToDigi(const edm::ParameterSet& iConfig) :
  ...
  ecalTPGLabel(iConfig.getParameter<edm::InputTag>("ecalTPGLabel")),
  hcalTPGLabel(iConfig.getParameter<edm::InputTag>("hcalTPGLabel")),
